      ...
      <div className="flex relative h-full justify-between gap-x-3">
        ...
        {intro && (
          <div
            ...
            className="fixed top-0 left-0  w-full h-full bg-Black/70 backdrop-blur-[2px] z-40"
          ></div>
        )}
        ...
        >
          ...
          >
            <span className="icon border-2 border-Green p-2 rounded-xl cursor-pointer">
              {" "}
              <FaBars />
            </span>
          </div>
          <span className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 rotate-90 flex items-center justify-center text-center text-xl text-Green font-extrabold tracking-widest">
            NavBar
          </span>
        </div>
