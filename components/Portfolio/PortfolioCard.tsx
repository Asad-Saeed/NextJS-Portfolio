...
const PortfolioCard = ({ data }: PortfolioCardProps) => {
  return (
    <div className="bg-EveningBlack/95 border border-DarkGray/30 rounded-xl overflow-hidden h-full">
      ...
      <div
        id="arrow"
        className="py-2 px-6 bg-EveningBlack/95 hover:-translate-y-10 transition-all ease-in-out duration-500"
      >
        <div className="flex justify-between p-0 m-0 ">
          ...
          <div className="text-Snow transition duration-500 hover:text-Green transform hover:-translate-y-1 hover:scale-110 pt-4 text-base">
            <a href={data?.url} target="_blank" rel="noreferrer">
              <svg
                aria-hidden="true"
                focusable="false"
        ...
        <p className="text-sm text-LightGray my-1">{data?.projectDetail}</p>
