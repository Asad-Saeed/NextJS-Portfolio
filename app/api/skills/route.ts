...
const skills = [
  ...
  },
  {
    ...
    skill: [{ title: "Javascript / Typescript", level: "95%" }],
  ...
  },
  {
    ...
    skill: [{ title: "Tailwind, Bootstrap, Module.css", level: "96%" }],
  ...
  },
  {
    ...
    skill: [{ title: "Next UI, Material UI, SCSS, Styled Components", level: "80%" }],
  ...
  },
  {
    ...
    skill: [{ title: "Context, Redux, Redux toolkit, Zustand", level: "90%" }],
  ...
  },
  {
    ...
    skill: [{ title: "Rest and GraphQL Api's Integration", level: "90%" }],
  ...
  },
  {
    ...
    skill: [{ title: "Git, GitHub, Bitbucket", level: "98%" }],
  ...
  },
  {
    ...
    skill: [{ title: "Node Js, Express JS", level: "67%" }],
  ...
  },
  {
    ...
    skill: [{ title: "MongoDB, FireBase, MySql", level: "50%" }],
  ...
  },
  {
    ...
    skill: [{ title: "WordPress Developer", level: "80%" }],
